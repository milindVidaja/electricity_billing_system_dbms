...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        ...
        meterText.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                try{
                    ...
                    ResultSet resultSet = c.statement.executeQuery("select * from Signup where meter_np = '"+meterText.getText()+"'");
                    if (resultSet.next()){
        ...
        Image boyImg = boyIcon.getImage().getScaledInstance(250,260, Image.SCALE_DEFAULT);
